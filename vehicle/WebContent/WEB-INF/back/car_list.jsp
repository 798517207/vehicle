...
<body class="app ">
			...
			<aside class="app-sidebar">
				...
				<ul class="side-menu">
					<li class="slide"><a class="side-menu__item"
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item"
								href="${pageContext.request.contextPath}/back/car/queryCar.handler"><span>教练车管理</span></a></li>
							<li><a class="slide-item"
					...
					<li class="slide"><a class="side-menu__item"
						...
						<ul class="slide-menu">
							<li><a class="slide-item"
								href="${pageContext.request.contextPath}/go/back/dynamic_add.handler"><span>行业动态发布</span></a></li>
												...
												<c:forEach items="${requestScope.map}" var="map">
													<tr>
														...
														<td>
															...
															<input type="button" value="删除" onclick="del(${map.CAR_ID})"> 
															<input type="button" value="修改" onclick="update(${map.CAR_ID})">
														</td>
													</tr>
												</c:forEach>
											</tbody>
	...
	<script>
			...
			function del(Id){
				$.ajax({
					type:"post",
					url:"${pageContext.request.contextPath}/back/car/deleteCar.handler?carId="+Id,
					dataType:'json',
			...
			function add(){
				window.location.href="${pageContext.request.contextPath}/back/car/addModelCar.handler";
			}
			function update(id){
				window.location.href="${pageContext.request.contextPath}/back/car/queryOneCar.handler?carId="+id;
			}
		</script>
