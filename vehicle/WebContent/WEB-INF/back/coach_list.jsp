					...
					<ul class="side-menu">
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="${pageContext.request.contextPath}/back/car/queryCar.handler"><span>教练车管理</span></a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item"  href=""${pageContext.request.contextPath}/go/back/dynamic_add.handler"><span>行业动态发布</span></a></li>
